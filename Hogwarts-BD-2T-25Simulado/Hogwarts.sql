...
CREATE TABLE feitico (
    ...
    nome_feitico VARCHAR(50) NOT NULL,
    descricao TEXT
);
select * from feitico
...
INSERT INTO Personagem (id_personagem,nome_personagem, data_nascimento) VALUES
(1,'Harry Potter', '31-07-1980',),
(2,'Hermione Granger', '19-09-1979', ),
(3'Rony Weasley', '01-03-1980', ),
(4,'Draco Malfoy', '05-06-1980', );
